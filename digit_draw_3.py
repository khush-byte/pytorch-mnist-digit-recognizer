...
MAX_DIGITS = 30
MIN_CNN_CONFIDENCE_PERCENT = 20.0
AUTO_SPLIT_MIN_ASPECT_RATIO = 0.82
AUTO_SPLIT_MAX_PARTS = 6
AUTO_SPLIT_MIN_AVERAGE_CONFIDENCE = 20.0
...
def recognize_sequence(event=None):
    ...
    if split_group_count:
        messages.append(
            f"Автоматически разделено слипшихся групп: {split_group_count}."
        )
...
instruction_label = tk.Label(
    ...
    text=(
        ...
        "слипшиеся цифры программа попробует разделить автоматически. "
        "Неизвестные символы выделяются красным."
    ),
    font=("Arial", 14)
)
