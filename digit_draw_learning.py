...
BASE_MODEL_FILE = "mnist_model.pth"
USER_MODEL_FILE = "mnist_model_user.pth"
...
#
# ВАЖНО:
# Архитектура должна совпадать с той, на которой был создан
# mnist_model.pth:
#
# 784 -> 128 -> 64 -> 10
# ============================================================
...
# Удаляется только mnist_model_user.pth.
# ============================================================
...
def reset_user_model():
    ...
    answer = messagebox.askyesno(
        "Сброс модели",
        (
            "Вернуть исходную модель mnist_model.pth?\n\n"
